...
<header id="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        <a class="navbar-brand" href="#">MOTI shop</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                <li class="nav-item active">
                    <a class="nav-link" href="index.php">On Sale</a>        </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="cart.php">Category <i class="fas fa-chevron-down"></i></a>
                </li>
                <li class="nav-item">
